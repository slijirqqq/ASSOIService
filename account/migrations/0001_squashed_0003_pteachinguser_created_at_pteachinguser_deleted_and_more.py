# Generated by Django 4.1.1 on 2022-10-14 17:24
...
class Migration(migrations.Migration):
    ...
    replaces = [('account', '0001_initial'), ('account', '0002_alter_user_phone'), ('account', '0003_pteachinguser_created_at_pteachinguser_deleted_and_more')]

    initial = True

    dependencies = [
        ('geo', '0001_initial'),
        ('academic', '0002_alter_academicdegree_table_alter_academictitle_table'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, db_index=True, max_length=14, null=True, region=None, unique=True, verbose_name='Phone number')),
                ...
                ('middle_name', models.CharField(blank=True, db_index=True, max_length=128, null=True, verbose_name='Middle name')),
                ('photo', models.ImageField(blank=True, default='images/default.png', upload_to='media/images', verbose_name='Avatar')),
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='Birth date')),
                ('education_level', models.CharField(blank=True, choices=[('high_education', 'High education'), ('college_tech_education', 'College tech education'), ('college_education', 'College education')], db_index=True, max_length=128, null=True, verbose_name='Education level')),
                ...
                ('registration_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registered_users', to='account.address', verbose_name='Registration address')),
                ('resident_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='resident_users', to='account.address', verbose_name='Resident address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_degree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academic.academicdegree', verbose_name='Academic degree')),
                ('academic_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academic.academictitle', verbose_name='Academic title')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2022, 10, 14, 17, 23, 24, 576752), verbose_name='Created at')),
                ('deleted', models.BooleanField(default=False, verbose_name='Deleted?')),
                ('updated_at', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2022, 10, 14, 17, 23, 31, 390419), verbose_name='Updated at')),
            ],
            options={
                'verbose_name': 'PTS',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2022, 10, 14, 17, 23, 44, 119906), verbose_name='Created at')),
                ('deleted', models.BooleanField(default=False, verbose_name='Deleted?')),
                ('updated_at', models.DateTimeField(auto_now_add=True, default=django.utils.timezone.now, verbose_name='Updated at')),
            ],
            options={
                'verbose_name': 'STS',
